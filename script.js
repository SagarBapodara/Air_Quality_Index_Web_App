// This web app is a part of Data Analytics and Management Internship at BISAG(N), Gandhinagar -->
...
const appId = "c7ddfd58e525a9ce62ee5a421f49ae01"  //API Key from Openweather.org
const link = "https://api.openweathermap.org/data/2.5/air_pollution"	// API end point link
...
const setValuesOfAir = airData => {
	...
	switch (aqi) {
		case 1:
			airStat = "Good"
			color = "rgb(19, 201, 28)"  // colors as per the value of air quality index
			break
			case 2:
				airStat = "Fair"
				color = "rgb(15, 134, 25)"
